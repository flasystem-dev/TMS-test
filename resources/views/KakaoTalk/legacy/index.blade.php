...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('/assets//css/popbill.css') }}" media="screen" />

    <title>팝빌 SDK PHP Laravel</title>
</head>

<body>
    <div id="content">
        <p class="heading1">팝빌 카카오톡 SDK PHP Laravel</p>
        <br />
        ...
        <fieldset class="fieldset1">
            ...
            <ul>
                ...
                <li><a href="KakaoTalk/ListATSTemplate">ListATSTemplate</a> (알림톡 템플릿 목록 확인) / <span class="success">DB 업데이트(완료)</span></li>
            </ul>
        </fieldset>
        <fieldset class="fieldset1">
            ...
            <fieldset class="fieldset2">
                ...
                <ul>
                    <li><a href="KakaoTalk/SendATS_one">SendATS</a> (알림톡 단건 전송) / <span class="ing">개발중</span></li>
