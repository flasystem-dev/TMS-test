...
@section('content')
    ...
    <form id="banner_form" name="banner_form" action="{{ url('/shop/bannerSave') }}" method="post" enctype="multipart/form-data">
    <header id="page-topbar">
        <div class="navbar-header">
            <div class="d-flex text-xl-center">
                <p class="font-size-20 fw-bold mt-3 mx-4" style="text-align:center" > 배너등록
                </p>
            </div>
                    ...
                    <div class="col-7">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <h4 class="card-title">배너 이미지</h4>
                                        <div>
                                            <div class="dropzone" id="dropzone_product_img" style="height:465px;">
                                                <div class="fallback">
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h4 class="card-title">배너 메모</h4>
                                        <textarea class="form-control" style="height:70px" name="text" aria-label="text"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
