                ...
                <form method="get" name="brand_select" action="?">
                    <div class="row">
                        ...
                        <div class="col-2 text-end">
                            <div class="row">
                                <div class="col-12">
                                    <button type="button" style="border-radius:3px;" onclick="popupForm()" class="btn btn-secondary waves-effect waves-light me-2">팝업등록</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            @foreach($popups as $row)
                                <tr class="text-center align-middle px-0">
                                    ...
                                    <!-- 사진 -->
                                    <td>
                                        <img src="{{$row->img}}" style="height:100px;width:auto;">
                                    </td>
                                    <!-- 기간 -->
                                    <td>
                                    ...
                                    <!-- 우선순위 -->
                                    <td>
                                        <select class="form-select orderBy_select" data-index="{{$row->id}}" data-type="popup">
                                            @for($i=1; $i<=5; $i++ )
                                    ...
                                    <td>
                                        <div class="form-switch">
                                            <input class="form-check-input check_used" type="checkbox" value="Y" data-index="{{$row->id}}" data-type="popup" {{$row->use_yn==='Y'? "checked":""}}>
                                        </div>
                                    </td>
                                    <!-- 삭제 -->
                                    <td class="center">
                                        <div class="center flex-wrap gap-2">
                                            <button class="btn btn-danger btn-soft-danger btn-sm delete_btn" data-index="{{$row->id}}" data-type="popup">삭제</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
