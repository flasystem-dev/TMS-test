...
@endsection
@section('content')
    <link href="{{ URL::asset('/assets/css/vendor/specification-form.css') }}" rel="stylesheet">
    <!-- 폼 양식 시작 -->
                ...
                <div class="col-12">
                    <div class="card pt-4">
                        ...
                        <table class="container">
                            <tr>
                                <td width="50%" colspan="2" rowspan="6" class="no-border center">
                                    ...
                                    <p class="ft-11">입금 예정
                                        계좌: {{$sp->getBankName($sp->bank_code)}} {{$sp->bank_number}} {{$sp->name_of_deposit}}</p>
                                </td>
                                <th> 발행처</th>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <input type="number" name="sp_order_amount" id="sp_order_amount"
                                           class="form-control sp_input_lg" value="{{$sp->sp_order_amount}}">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <input type="number" name="sp_vendor_amount" id="sp_vendor_amount"
                                           class="form-control sp_input_lg" value="{{$sp->sp_vendor_amount}}">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <input type="number" name="sp_vendor_options_amount" id="sp_vendor_options_amount"
                                           class="form-control sp_input_lg" value="{{$sp->sp_vendor_options_amount}}">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="center ft-11">
                                    ...
                                    <input type="number" name="sp_service_percent" id="sp_service_percent"
                                           class="form-control sp_input_sm" value="{{$sp->sp_service_percent}}">
                                    %
                                </td>
                            </tr>
                            <tr>
                                <td class="center" colspan="2">2. 차액수익</td>
                                <td class="right" id="diff_amount">{{number_format($sp->difference_amount)}}</td>
                            ...
                            <tr>
                                ...
                                <td class="center ft-11">당월 카드결제 총액
                                    <input type="number" name="sp_card_amount" id="sp_card_amount"
                                           class="form-control sp_input_cd" value="{{$sp->sp_card_amount}}">
                                    원의 3.3%
                                </td>
                            </tr>
                            <tr>
                                ...
                                <!-- 기타2 + 기타3 -->
                                <td class="right" id="etc_price1">{{number_format($sp->sp_etc2+$sp->sp_etc3)}}</td>
                                <td class="center ft-11">
                                    <div class="input-group">
                                        <span class="input-group-text sp_input_sm_span" id="basic-addon1">기타2</span>
                                        <input type="number" name="sp_etc2" id="sp_etc2"
                                               class="form-control sp_input_sm" value="{{$sp->sp_etc2}}">
                                    </div>
                                    <span class="sp_input_icon">+</span>
                                    <div class="input-group">
                                        <span class="input-group-text sp_input_sm_span" id="basic-addon1">기타3</span>
                                        <input type="number" name="sp_etc3" id="sp_etc3"
                                               class="form-control sp_input_sm" value="{{$sp->sp_etc3}}">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="highlight center">A. 수익 총액</td>
                                <td class="highlight right revenue">{{number_format($sp->revenue_amount)}}</td>
                            ...
                            <tr>
                                ...
                                <!-- 기타 1 -->
                                <td class="right" id="etc_price2">
                                    {{number_format(-$sp->sp_etc1)}}
                                </td>
                                <td class="center ft-11">
                                    <div class="input-group">
                                        <span class="input-group-text sp_input_sm_span" id="basic-addon1">기타1</span>
                                        <input type="number" name="sp_etc1" id="sp_etc1"
                                               class="form-control sp_input_sm" value="{{$sp->sp_etc1}}">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <!-- 원천징수 + 서비스 금액 + 기타2 -->
                                <td class="highlight right deduction">{{number_format($sp->deduction_amount)}}</td>
                        ...
                        <table class="container">
                            <tr>
                                <th>수익총액(A)</th>
                                <td class="right revenue">{{number_format($sp->revenue_amount)}}</td>
                                <th>공제총액(B)</th>
                                <td class="right deduction">{{number_format($sp->deduction_amount)}}</td>
                            </tr>
                            <tr>
                        ...
                        <div class=" p-2 center ft-11">
                            <p class="highlight">※
                                <input type="date" name="deposit_date" id="deposit_date"
                                       class="form-control sp_input_date" value="{{$sp->deposit_date}}">
                                입금 예정입니다.</p>
                        </div>
                    </div>
                </div>
                <div class="text-end">
                    <button type="button" class="btn btn-danger" onclick="update_specification()">수정</button>
                </div>
            </div>
        </div> <!-- 내용 끝 ( col ) -->
    </form>
