...
class CalcVendorExport implements FromView, ShouldAutoSize, WithDefaultStyles, WithColumnFormatting, WithStyles
{
    protected $vendors;
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'AE' => NumberFormat::FORMAT_DATE_YYYYMMDD2, // 날짜 (yyyy-mm-dd)
        ];
    }
    ...
    public function view(): View
    {
        ...
        return view('excel.calc-vendor-amount', $data);
    }
}
